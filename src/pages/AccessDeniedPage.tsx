  ...
  return (
    <main className="grid min-h-screen place-items-center bg-fruit-shell bg-[size:auto_auto] px-5 py-12 font-fruit">
      <section className="w-full max-w-lg rounded-fruit-xl border border-fruit-cardBorder bg-fruit-parchment/95 px-8 py-10 text-center shadow-fruit-lg">
        ...
        <p className="mt-3 font-bold leading-relaxed text-fruit-muted">
        ...
        <button
          className="mt-6 rounded-fruit bg-fruit-danger px-6 py-3 font-black text-fruit-paper shadow-danger-lift active:translate-y-1 active:shadow-danger-press disabled:opacity-60"
          type="button"
          disabled={loading}
