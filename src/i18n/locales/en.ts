export const en = {
  ...
  photos: {
    ...
    loadError: "We couldn't load the memories right now.",
    fitToScreen: "Fit photo to screen",
    fullscreenLabel: "Fullscreen memory photo",
    closeFullscreen: "Close fullscreen photo",
  ...
  memories: {
    ...
    sortLabel: "Organise memories by",
    sortTime: "Time",
    sortMap: "Map region",
    sortTag: "Tag",
    ...
    deleteConfirm: "Delete this photo and its description? This cannot be undone.",
    deleteError: "We couldn't delete this memory. Please try again.",
    changeDate: "Change date",
    changingDate: "Saving date...",
    changeDateError: "We couldn't change this memory's date. Please try again.",
    love: "Love",
    author: {
      dad: "Dad",
      mum: "Mum",
    ...
    form: {
      ...
      aiLanguage: "AI writing language",
      aiChinese: "中文",
      aiEnglish: "English",
      aiGenerate: "AI help me write the description",
      aiWriting: "AI is looking at the photo...",
      aiError: "We couldn't write a description for this photo. Please try again.",
  ...
  stories: {
    ...
    aiGeneratorTitle: "AI story generator",
    aiGeneratorDescription: "Describe the story you want, and AI will fill in all four story fields.",
    aiGeneratorPlaceholder: "For example: A gentle story about a little apple learning to share...",
    aiGeneratorLanguage: "Generating in {{language}}",
    aiGenerate: "Generate story",
    aiGenerating: "Writing story...",
    aiError: "We couldn't generate this story. Please try again.",
